use mysql::{Result, PooledConn, params, Error as MysqlError, Value::Double};
use mysql::prelude::*;
...
pub fn select_insulin_item(conn: &mut PooledConn, insulin_item: &InsulinItem) -> Result<Vec<InsulinItem>, Box<dyn Error>> {
    ...
    let result: Vec<InsulinItem> = conn.exec_map(
        query,
        params,
        |(insulin_item_id, insulin_item_name, units, uom, created_at, notes, is_active, created_by): (String, String, f32, String, NaiveDateTime, Option<String>, i32, String)| {
            InsulinItem {
...
pub fn select_all_insulin_item(conn: &mut PooledConn, insulin_item: &InsulinItem) -> Result<Vec<InsulinItem>, Box<dyn Error>> {
    let mut query = String::from(r#"
        SELECT insulin_item_id, insulin_item_name, units, uom, created_at, notes, is_active, created_by
        FROM insulin_item
    "#);
...
pub fn select_insulin_assign(conn: &mut PooledConn, insulin_assign: &InsulinAssign) -> Result<Vec<InsulinAssign>, Box<dyn Error>> {
    let mut query = String::from(r#"
    ...
    let result: Vec<InsulinAssign> = conn.exec_map(
        query,
        params,
        |(insulin_assign_id, insulin_item_id, added_at, batch_no, notes, is_active, created_by): (String, String, NaiveDateTime, String, Option<String>, i32, String)| {
            InsulinAssign {
...
pub fn select_all_insulin_assign(conn: &mut PooledConn, insulin_assign: &InsulinAssign) -> Result<Vec<InsulinAssign>, Box<dyn Error>> {
    let mut query = String::from(r#"
    ...
    let result: Vec<InsulinAssign> = conn.exec_map(
        query,
        params,
        |(insulin_assign_id, insulin_item_id, added_at, batch_no, notes, is_active, created_by): (String, String, String, String, Option<String>, i32, String)| {
            InsulinAssign {
                insulin_assign_id: Uuid::parse_str(&insulin_assign_id)
                .unwrap_or_else(|_| Uuid::nil()),
                insulin_item_id: Uuid::parse_str(&insulin_item_id)
...
pub fn select_all_insulin_assign_usage(conn: &mut PooledConn, insulin_assign: &InsulinAssign) -> Result<Vec<InsulinAssignUsage>, Box<dyn Error>> {
    let mut query = String::from(r#"
...
pub fn delete_insulin_assign(conn: &mut PooledConn, insulin_assign: &InsulinAssign) -> Result<(), Box<dyn Error>> {
    conn.exec_drop(
...
pub fn select_insulin_usage(conn: &mut PooledConn, insulin_usage: &InsulinUsage) -> Result<Vec<InsulinUsage>, Box<dyn Error>> {
    let mut query = String::from(r#"
    ...
    let result: Vec<InsulinUsage> = conn.exec_map(
        query,
        params, 
        |(insulin_usage_id, insulin_assign_id, units, administered_at, notes, is_active, created_by): (String, String, f32, NaiveDateTime, Option<String>, i32, String)| {
            InsulinUsage {
...
pub fn select_all_insulin_usage(conn: &mut PooledConn, insulin_usage: &InsulinUsage) -> Result<Vec<InsulinUsage>, Box<dyn Error>> {
    let mut query = String::from(r#"
        SELECT insulin_usage_id, insulin_assign_id, units, administered_at, notes, is_active, created_by
        FROM insulin_usage
        WHERE is_active = 1
    ...
    let result: Vec<InsulinUsage> = conn.query_map(
        query,
        |(insulin_usage_id, insulin_assign_id, units, administered_at, notes, is_active, created_by): (String, String, f32, String, Option<String>, i32, String)| {
            InsulinUsage {
                insulin_usage_id: Uuid::parse_str(&insulin_usage_id)
                .unwrap_or_else(|_| Uuid::nil()),
                insulin_assign_id: Uuid::parse_str(&insulin_assign_id)
...
pub fn delete_insulin_usage(conn: &mut PooledConn, insulin_usage: &InsulinUsage) -> Result<(), Box<dyn Error>> {
    conn.exec_drop(
